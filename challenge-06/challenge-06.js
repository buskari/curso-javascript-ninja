...
desafio.
*/
var teams = ['Time A', 'Time B', 'Time C', 'Time D', 'Time E'];
...
function showTeamPosition( number ) {
    if( number < 1 || number > 5) {
        return 'O time nesta posição não está cadastrado.'
    }
...
function convertToHex( color ) {
    ...
    return `O hexadecimal para a cor ${color} é ${hexCode}`;
}
