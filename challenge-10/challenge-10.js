...
*/
var five = '5';
console.log( Number(five) + ' é número?', typeof Number(five) === 'number' );

var concat = 10 + 10;
console.log( '"' + String(concat) + '" é uma string? E é igual a "1010"?', typeof String(concat) === 'string' );
...
*/
operationSignal = 'invalid operator';
var mod = calculator(operationSignal);
