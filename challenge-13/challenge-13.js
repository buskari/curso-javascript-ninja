...
brasil.unshift('Amazonas', 'Roraima', 'Rondônia')
console.log(brasil);
...
var cearaIncluded = brasil.some(function(item) {
    return item == 'Ceará';
});
console.log(
    cearaIncluded 
...
*/
var map = brasil.map(function(item, index) {
    return {
        id: ++index,
