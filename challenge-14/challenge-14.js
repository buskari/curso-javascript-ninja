...
var justNumbers = [];
numberObjects.forEach(function(item, index, array) {
...
*/
console.log( '\nOperation:' );
var operation = justMod20r3.reduce(function(total, item) {
    return ( total + 1 ) * item;
});
...
*/
console.log( '\nOperation 2:' );
var operation2 = justMod20r3.reduceRight( function( total, item ) {
    return ( total + 1 ) * item;
});
...
var name = ['An', 'dris'];
var nameP = name.reduce( function( complete, element, index ) {
    return complete + 'P' + element;
}, '');
...
*/
console.log( '\nInversed Name:' );
var inversedName = name.reduceRight( function( complete, element ) {
